...
The [ENSEMBL website](http://www.ensembl.org/) provides references for different organisms; [here](http://www.ensembl.org/Drosophila_melanogaster/Info/Index) for the fruitfly. 
