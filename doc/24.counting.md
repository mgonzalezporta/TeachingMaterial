...
**Exercise:** 0ne of the input files required by htseq-count is a GTF file. For this practical, you will find this file under the directory `reference`. Which information does it contain? [Solution](https://github.com/mgonzalezporta/TeachingMaterial/blob/master/solutions/_counting_ex1.md)

This GTF file can be retrieve from the [ENSEMBL website](http://www.ensembl.org/) which provides references for different organisms; [here](http://www.ensembl.org/Drosophila_melanogaster/Info/Index) for the fruitfly. 
Note: Former releases can be retrieve from the [ftp server](ftp://ftp.ensembl.org/pub/) or browse from the [*archives*](http://www.ensembl.org/info/website/archives/index.html) part of the ENSEMBL website.
