...
**Exercise:** One of the input files required by htseq-count is a GTF file. For this practical, you will find this file under the directory `reference`. Which information does it contain? [Solution](../solutions/_counting_ex1.md)

*Note:* This GTF file can be retrieved from the [ENSEMBL website](http://www.ensembl.org/), which provides references for different organisms; [here](http://www.ensembl.org/Drosophila_melanogaster/Info/Index) for the fruitfly. 
Former releases can be retrieved from the [ftp server](ftp://ftp.ensembl.org/pub/) or the [*archives*](http://www.ensembl.org/info/website/archives/index.html).
...
**Exercise:** The other required input file is a BAM file. Can you spot any specific requirement regarding this file?
...
* What information does the command `seqlevels(aln_chr4)` provide?
  *Hint:* look for the *GAlignmentPairs* class
